...
As we are headed into our final few weeks, I want to provide just a little bit of clarification about our final writing assignment. As noted in our syllabus, the prompt for our final writing assignment is: 
...
3. Suggest an adjustment to public policy (that shows appreciation and understanding of Lessig's four modalities of regulation)
...
In the past couple of weeks, we have attempted to trace a kind of trajectory that moves from founding ideals of the enlightenment to an argument for freedom of expression.

The idea was that with Rousseau, Kant and others, a new idea of governance was emerging, whereby the people governed themselves. For this not to result in chaos Rousseau had to make a distinction between our Private Wills (our immediate inclinations) and our real selves represented by the General Will. The goal was for a society governed, not by everyone's competing whims, but by their true autonomous selves, even if they were not yet capable of knowing their own "real will". 
...
Throughout this argument there was an implicit assumption that "code of communication" required speech to happen in certain places and in certain ways. It remains an open question how much the equation "More speech equals better deliberation" depends on the "side effects" of the platform through which speech happens.

It is not surprising then, that in Habermas's history of the "public sphere", the birth of the enlightenment coincides with a unique type of communications environment that thrived in late 18 and early 19th century: namely 1) through a highly diverse market of niche newspapers and periodicals in which no publisher was powerful enough to control the behavior of others and 2) and generally tolerant political regimes (administrative) content to allow the speech of private individuals about public matters (Kant's "free public use of reason") to proceed unimpeded.
...
It's important to keep in mind that, in Habermas's view, the threat of against speech comes from two directions. Direct censorship through government regulation and private commercial control of communication channels that determine who has access to speech. 
...
As Shapiro notes, the 20th saw the mass the consolidation of ownership of communication channels to handful of powerful players
...
Today we want to consider the arguments and reason for this optimism. Knowing that we will seen return to many contemporary critiques of the Internet, here he want to consider the other side of the argument and focus on the initial strengths of the Internet as a communications technology.
...
The Chapters 1 and 3 offer us a good overview of Shapiro's main thesis: that the Interent Revolution is actual a Control Revolution, and therein lies its strength.

There are many suggestive passages in these chapters, but here is one that stood out to me.
...
1. Future critics like Sunstein are a little more cautious about whether this is a net positive for democracy. To say that the people will have control sounds very democratic, but Sunstein will want to more precise about what we mean by democracy. If we are talking about "deliberative democracy", it does not necessarily follow that deliberative democracy is improved when people are able to speak directly to power or influence political decisions. Habermas is likely to agree, that much depends on whether these voices are being applied to directly to decisions makers or are being submitted to the public forum for refinement through the process of dialectic.
...
The central message of chapter appear to connect well with the trajectory we've been tracing.
...
<span class="respond"/> Can you think of other examples where "internet deliberation" has positively corrected stories or spins broadcast by mass media.

<span class="respond"/> Is there a flip side to this? Does this "many-to-many" modality also sometimes lead to "baseless" conspiracy? If so, what are the other conditions that determine when this community deliberation works well and when it does not?
</div>
...
This quotation capture Shapiro's concern about Mass media and optimism about the Internet fairly well. 

If ownership of a print press was required for free speech, this is precisely what tradition means of broadcasting denied individuals and help to create uniform and un-dialogical pseudo public sphere about which Habermas complains.

The internet then seems very clearly to address this problem. 

Inasmuch as any individual person can create a website that can reach anyone else on the globe, hasn't every single person acquired printing press.

<div class="discussion" markdown="1">

<span class="response"> Do you think this is true? Does every individual now have an equal ability to broadcast? 

<span class="response"> If so, but we still feel like the public sphere is "slanted" in favor of certain private interest over others, what other dimensions of the means of communication might Leibold have overlooked. What else might be needed for each voice to have an equal standing in the public sphere. (Shapiro, very subtly, offers a couple of suggestions in the very last paragraph of this chapter.)

</div>

## Personalization of Experience - Chapter 5

Chapter 5 is interesting for, since we know are already of Sunstein's critique of the idea of the "daily me". And yet here we have a chapter where Shapiro is praising the "personalization" abilities of the modern internet as once if its best assets. 
