...
With today's reading, our goal is to continue looking at the foundational arguments used to support the equation that "more speech equals greater deliberation". 

As we discussed last time, champions of deliberative democracy have long argued that the freedom of expression is critical to goals of a deliberative (rather than a direct) democracy. We began to see this in Kant's *What is Enlightenment*, today we to look closer at this argument in what is perhaps the most of famous defense of freedom of expression, John Stuart Mill's, On Liberty, Chapter 2, "on liberty of thought and discussion". From there we want to look at an equally famous contemporary philosopher Jürgen Habermas (who relies heavily on the thought of Fröbel) and his similar argument as to why deliberative democracy and the "public sphere" requires as much freedom of expression as possible. 
...
These four arguments revolve around Mill's response to a central objection: if we know the truth, why should we, a society, allowed it to be contradicted by error. 

I'd like to discuss each of these arguments in turn.

As Mill states at the outset, his response follows to main paths: 
...
<span class="respond"/> What do you think about this argument? How far should this argument be stretched? Are there some truth so certain or are there some truths or useful, or some truths so false or dangerous, that it does not seem inappropriate to outlaw the falsehoods expression?

</div>

The argument then moves forward, by assuming the premise disputed in his first response. Let's assume, he says, that society does actually have access to the truth. Are there still important reason that a society might want to allow dissenting voices to be heard?

<div class="discussion" markdown="1">

Noted as "second" in his final recapitulation but actually discussed last in his chapter (starting around p. 84), he notes that even if the received opinion (the dominant social belief) is "mostly true" and if the opinion is "mostly false", there it still has some important part of the truth that the "mostly false" opinion can deliver.
...
Mill offers to arguments in this regard, 3 and 4 respectively in his final recapitulation


<div class="discussion" markdown="1">

<span class="respond"/> What is the third argument? (Hint: it has something to do with understanding the "reason" or "grounds" or an opinion.) (See around p. 64.)

Again, we're looking to test his argument. So...

<span class="respond"/> Does he argument presume anything about the "platform" of speech? (Such that the argument might not follow if the "platform" where changed?)

<span class="respond"/> Are there any exceptions or extremes where his position about falsehood improving our understanding of the truth would not follow.
...
{:.question}
What difficulty does Rousseau's solution face? (We've look at this difficulty once before.)

{:.answer}
How does one actually find the general will? How does one avoid the tyranny of the majority)
...
Habermans suggests that discursive will-formation requires certain conditions to which Fröbel did not give sufficient attention.
...
{:.rquestion} To what extend is a government justified in enacting laws or restricting freedom in order to acquire these conditions.

The "creation of the condition" creates political problems for how to achieve them. 

Resolving these problem seems to require external regulation and perhaps even force.
...
How can the will of the people be invoked to justify the conditions for deliberation, since by definition these conditions would be enforced prior to deliberation and prior to the determination of the will of the people.
...
Habermas here seems to rely on or trust that there would be sufficient rationality or civic virtue within the people themselves to recognize the "rationality" of these conditions prior to deliberation itself.

In this way, he would expect individuals to recognize that intervention is justified *a priori* in anticipation of the will of the people. Conditions would be imposed that, while not, yet chosen, theoretically would be chosen if the condition were in place for healthy will formation to develop.
