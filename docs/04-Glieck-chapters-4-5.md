...
A central goal in our observations is the way the shift in medium enabled the new possibilities for intellectual thought, but also came with trade offs. 

In this lesson, we want to begin look at the beginnings of analogous communication shifts, namely the shift to electronic communication, are communicating via wires, rather than paper or sound. 

But our goal here remains similar. We want to observe the way new technological possibilities (and there auxiliary effects on markets, commerce, and human behavior) pushed human beings to see things in new ways and recognize real concepts and ideas that were never before seen, precisely because they available media never pushed us to see them. 

More specifically, it is with the invention of the telegraph that we will see new a kind of circular and almost self-referential process: new media pushing us to ask question about what a "medium" is, and the result new conception of a "medium" given rise to drastic changes in communication and its possible modalities. 

# Babbage

# Telegraph 

Let's consider the following video and then consider some questions together:

[play first part about developing open and closed circuit and the needle]
...
The challenge forced theorist to engage in the process of **abstraction**. This an attempt to see a more general pattern standing behind complexity.

[video of needle system, its slowness and morse code]
https://www.khanacademy.org/computing/computer-science/informationtheory/info-theory/v/morse-code-the-information-age-language-of-coins-8-12
...
But do any of us want to say that this thing I drew is a triangle. If we look closely at what I've drawn, none of the lines are perfectly straight, none of the angles are perfectly drawn. If we used this triangle as the "form" of all triangles, its imperfections would certainly destroy all geometry. 

So what then is this that I have drawn?

We might say, it is merely a visual approximation of the pure idea of a triangle that can never actually be drawn. The picture is there, not to draw my attention to, but to point my attention to the perfect idea it illustrates. 

Oddly then, even though we usually think of an image when we see a triangle, a triangle cannot be drawn and it cannot be defined by its appearance. 
...
The decision of telegraph engineers to represent a letter in a new way, via needle position or morse code, required them to "abstract" from the visual appearance of letter, and think about what a letter is independent of its "material manifestation". 
...
**In Sum** While this still may be confusing, let's simply mark this idea as critical and something we will return when we learn about Claude Shannon and his new idea of "information"

# Telegraph: Analogous understanding and new paradigms
...
McLuhan has example of people buying books to get them copied by a scribe.
...
# Telegraph, Market, and New Ideas. 

[video about code books]
[quotations from Glieck]
...
[video about telegraph market forces and development of code boosk]
...
**In sum**: the telegraph company needed a reliable/uniform way to measure how much information was being sent that was independent or abstracted from the number of letters. This would be a reliable and uniform quantity, whether a message is first written in 100 letters or 20 letters. 
